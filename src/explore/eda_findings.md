...
Heavy right skew with a spike at 100%. 59.3% of rows have CTR=0. The 100% CTR spike represents the 1,115 rows with 1 click / 1 impression. CTR > 100% (51 rows) is clipped at 200% on the x-axis — these are legitimate bookmark/notification clicks.
